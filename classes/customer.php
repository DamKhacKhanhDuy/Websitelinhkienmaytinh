...
<?php
    class customer {
        ...
        public function insert_customers($data){
            ...
            if($name =="" || $email =="" || $address  =="" || $city =="" || $phone =="" || $password ==""){
            ...
            if($result_check){
                ...
                $query = "INSERT INTO tbl_customer(name,email,address,city,phone,password) VALUES('$name','$email','$address','$city','$phone','$password')";
                $result = $this->db->insert($query);
                if($result){
                    $alert = "<span class='success'> Tạo tài khoản thành công </span>";
                    return $alert;
                }else{
                    $alert = "<span class='error'> Chưa tạo tài khoản thành công </span>";
                    return $alert;
                }
            }
        }
    ...
    if($email =='' || $password ==''){
            $alert = "<span class='error'>Không để trống tài khoản và mật khẩu</span>";
            return $alert;
    }else{
        ...
        $phone = mysqli_real_escape_string($this->db->link,$data['phone']);
            ...
            if($name =="" || $email =="" || $address  =="" || $phone ==""){
                ...
                if($result){
                    ...
                    $alert = "<span class='error'> Chưa cập nhật thông tin thành công </span>";
                    return $alert;
                }
            }
        }
