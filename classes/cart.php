...
<?php
    class cart {
        ...
        public function add_to_card($id, $quantity){
        ...
        public function update_quantity_card($cartId, $quantity){
            $quantity = mysqli_real_escape_string($this->db->link,$quantity);
            ...
            $query = "UPDATE tbl_cart SET quantity = '$quantity' WHERE cartId = '$cartId'";
               ...
               if($result){
                ...
                $msg = "<span class='error'> Chưa cập nhật số lượng </span>";
                return $msg;
               }
        }
        public function del_product_cart($cartid){
            ...
            if($result){
                ...
                $msg = "<span class='error'> Chưa xóa thành công </span>";
                return $msg;
               }
        }
    ...
    public function shifted($id, $price, $time){
        ...
        $query = "UPDATE tbl_order SET status = '1' WHERE id = '$id' AND date_order= '$time' AND price = '$price'";
               ...
               if($result){
                ...
                $msg = "<span class='error'> Chưa cập nhật đơn hàng thành công </span>";
                return $msg;
               }
    }
}
